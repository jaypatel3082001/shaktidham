            ...
            <tr>
              ${pair
                .map((seatNumber, index) => {
                  ...
                  return item
                    ? `
                      <td class="border border-black p-2 text-center w-1/6 bg-red-500 text-white">${item.seatNumber}</td>
                      <td class="border border-black p-2 text-left ">${item.name} -- ${item.vilage}</td>`
                    : `
                      <td class="border border-black p-2 text-center w-1/6 bg-red-500 text-white">${seatNumber}</td>
